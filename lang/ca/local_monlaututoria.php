...
$string['privacy:metadata:enabledcohort'] = 'Quines cohorts de Moodle un administrador ha habilitat com a rellevants per a aquest connector, incloent qui ho va configurar.';
$string['privacy:metadata:enabledcohort:cohortid'] = 'La cohort de Moodle habilitada (no és una dada personal en si, és una referència a la pròpia cohort).';
...
$string['setting_sopcohort'] = 'Cohort d\'orientadors SOP';
$string['setting_sopcohort_desc'] = 'Cohort de Moodle amb els orientadors del SOP com a membres. Quan es defineix, el formulari d\'assignació manual ofereix un desplegable amb aquestes persones en triar el tipus "Orientador SOP", en lloc d\'una cerca lliure d\'usuaris. Crea el cohort a Administració del lloc → Usuaris → Cohorts i afegeix-hi els orientadors.';
$string['entry_field_sopobservations'] = 'Observacions SOP';
$string['entry_field_recommendationsop'] = 'Recomanacions SOP';
$string['entry_sop_register'] = 'Registrar tutoria SOP';
$string['entry_sop_register_title'] = 'Registrar tutoria SOP — {$a}';
$string['entry_sop_pick_student_title'] = 'Registrar tutoria SOP';
$string['entry_sop_pick_student_empty'] = 'No tens alumnes assignats com a orientador SOP.';
$string['entry_sop_badge'] = 'SOP';
$string['entryattachmentcategory_sop_report'] = 'Informes facilitats';
$string['entryattachmentcategory_sop_recommendation'] = 'Recomanacions SOP';
$string['error_sop_not_orientador'] = 'Només l\'orientador SOP de l\'alumne (o coordinació) pot registrar una tutoria SOP.';
$string['entry_has_attachments'] = 'Té fitxers adjunts';
$string['student_summary_no_sop'] = 'Sense orientador SOP';
...
$string['dashboard_studentfilter_covered'] = 'Amb tutoria';
$string['dashboard_studentfilter_notutoring'] = 'Sense tutoria';
...
$string['dashboard_title_of'] = 'Panell de {$a}';
$string['dashboard_mypanel'] = 'El meu panell';
$string['dashboard_viewtutorpanel'] = 'Veure el panell de';
$string['dashboard_viewtutorpanel_action'] = 'Veure panell del tutor';
...
$string['cohort_visibility_title'] = 'Cohorts habilitades';
$string['cohort_visibility_intro'] = 'Tria quines cohorts de Moodle són rellevants per a Monlau Tutoria. Només les marcades aquí apareixeran en la creació d\'assignacions, l\'assignació per cohort i el tauler de coordinació. Desmarca les que vulguis amagar (per exemple, cohorts de personal). Avís: si en desar no en queda cap de marcada, s\'interpretarà com "sense restricció" i es tornaran a mostrar totes — deixa\'n marcada almenys una per amagar la resta de debò.';
$string['cohort_visibility_empty'] = 'Encara no hi ha cap cohort creada en aquest lloc.';
$string['cohort_visibility_save'] = 'Desar cohorts habilitades';
$string['cohort_visibility_saved'] = 'Cohorts habilitades actualitzades correctament.';
...
$string['help_page_intro_simple'] = 'Guia ràpida del registre de tutories.';
$string['help_concept_entry_short_simple'] = 'És el registre d\'una actuació tutorial concreta: quan va passar, amb quina modalitat de contacte, per quin motiu, i el seu contingut en dues parts — el comentari compartit amb l\'alumne i la nota interna (només la veuen tutors i coordinació).';
$string['help_concept_entry_full_simple'] = 'Registres una tutoria des de la fitxa de l\'alumne (pestanya Tutories) o des del tauler. Es pot editar poc després de crear-la sense donar motiu; passat un temps configurable, editar-la exigeix explicar per què. Mai s\'esborra: si cal deixar-la sense efecte, s\'anul·la, i queda constància que va existir.';
$string['help_visibility_body_simple'] = 'L\'alumne només veu el contingut de tutoria marcat com a "compartit amb l\'alumne": data, modalitat, motiu i el comentari compartit. Mai veu la nota interna. Això s\'aplica sempre al servidor, mai s\'amaga només amb estils.';
