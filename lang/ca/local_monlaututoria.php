...
$string['settings_entryeditwindow_title'] = 'Finestra d\'edici� de tutories';



$string['assignment_reassign'] = 'Reassignar tutor';
$string['assignment_reassign_title'] = 'Reassignar tutor';
$string['assignment_reassign_confirm'] = 'Confirmar reassignaci�';
...
$string['assignment_reassign_intro'] = 'Tanca l\'assignaci� principal actual i en crea una de nova amb el tutor seleccionat, conservant l\'historial.';
$string['assignment_field_newtutor'] = 'Nou tutor';
$string['assignment_field_reassignreason'] = 'Motiu de la reassignaci�';
$string['assignment_field_reassigndate'] = 'Data efectiva de la reassignaci�';
$string['assignment_field_keepcotutors'] = 'Mantenir actius els cotutors de l\'alumne';
$string['warning_assignment_reassign'] = 'Aquesta acci� tancar� l\'assignaci� principal actual i en crear� una de nova amb el tutor seleccionat.';
$string['warning_assignment_reassign_cotutors'] = 'L\'alumne t� {} cotutor(s) actiu(s). Pots mantenir-los o tancar-los dins de la mateixa reassignaci�.';
$string['error_assignment_reassign_only_primary'] = 'Nom�s es pot reassignar una assignaci� principal activa.';
$string['error_assignment_reassign_not_confirmed'] = 'Cal confirmar la reassignaci�.';
...
$string['coordination_scope_intro'] = 'Selecciona un coordinador i assigna-li les cohorts que podr� supervisar. Dins del panell despr�s podr� filtrar per tutor.';
