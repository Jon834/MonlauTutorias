...
$string['entry_sop_register_title'] = 'Register SOP entry — {$a}';
$string['entry_sop_pick_student_title'] = 'Register SOP entry';
$string['entry_sop_pick_student_empty'] = 'You have no students assigned to you as SOP orientation tutor.';
$string['entry_sop_badge'] = 'SOP';
$string['entryattachmentcategory_sop_report'] = 'Reports provided';
$string['entryattachmentcategory_sop_recommendation'] = 'SOP recommendations';
$string['error_sop_not_orientador'] = 'Only the student\'s SOP orientation tutor (or coordination) can record a SOP entry.';
$string['entry_has_attachments'] = 'Has attachments';
$string['student_summary_no_sop'] = 'No SOP orientation tutor';
...
$string['dashboard_studentfilter_covered'] = 'With tutoring';
$string['dashboard_studentfilter_notutoring'] = 'Without tutoring';
...
$string['dashboard_title_of'] = 'Panel of {$a}';
$string['dashboard_mypanel'] = 'My panel';
$string['dashboard_viewtutorpanel'] = 'View the panel of';
$string['dashboard_viewtutorpanel_action'] = 'View tutor panel';
...
$string['help_page_intro_simple'] = 'Quick guide to recording tutoring entries.';
$string['help_concept_entry_short_simple'] = 'The record of a specific tutoring action: when it happened, the contact modality, the reason, and its content in two parts — the comment shared with the student and the internal note (visible only to tutors and coordination).';
$string['help_concept_entry_full_simple'] = 'You register an entry from the student file (Tutoring tab) or from the dashboard. It can be edited shortly after creating it without giving a reason; past a configurable window, editing it requires explaining why. It is never deleted: if it needs to stop applying, it is annulled, and the fact that it existed is kept.';
$string['help_visibility_body_simple'] = 'The student only sees tutoring content marked as "shared with the student": date, modality, reason and the shared comment. They never see the internal note. This is enforced on the server, never hidden with CSS alone.';
