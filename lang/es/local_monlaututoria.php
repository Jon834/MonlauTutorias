...
$string['settings_entryeditwindow_title'] = 'Ventana de edici�n de tutor�as';

$string['assignment_reassign'] = 'Reasignar tutor';
$string['assignment_reassign_title'] = 'Reasignar tutor';
$string['assignment_reassign_confirm'] = 'Confirmar reasignaci�n';
$string['assignment_reassign_confirm_checkbox'] = 'Confirmo que deseo reasignar esta tutor�a a otro tutor.';
$string['assignment_reassign_success'] = 'Tutor reasignado correctamente.';
$string['assignment_reassign_intro'] = 'Cierra la asignaci�n principal actual y crea una nueva con el tutor seleccionado, conservando el historial.';
$string['assignment_field_newtutor'] = 'Nuevo tutor';
$string['assignment_field_reassignreason'] = 'Motivo de la reasignaci�n';
$string['assignment_field_reassigndate'] = 'Fecha efectiva de la reasignaci�n';
$string['assignment_field_keepcotutors'] = 'Mantener los cotutores activos del alumno';
$string['warning_assignment_reassign'] = 'Esta acci�n cerrar� la asignaci�n principal actual y crear� una nueva con el tutor seleccionado.';
$string['warning_assignment_reassign_cotutors'] = 'El alumno tiene {} cotutor(es) activo(s). Puedes mantenerlos o cerrarlos en la misma reasignaci�n.';
$string['error_assignment_reassign_only_primary'] = 'Solo se puede reasignar una asignaci�n principal activa.';
$string['error_assignment_reassign_not_confirmed'] = 'Debes confirmar la reasignaci�n.';
...
$string['coordination_scope_intro'] = 'Selecciona un coordinador y as�gnale las cohortes que podr� supervisar. Dentro del panel, despu�s podr� filtrar por tutor.';
