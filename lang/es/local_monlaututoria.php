...
$string['entry_has_attachments'] = 'Tiene archivos adjuntos';
$string['student_summary_no_sop'] = 'Sin orientador SOP';
...
$string['dashboard_title_of'] = 'Panel de {$a}';
$string['dashboard_mypanel'] = 'Mi panel';
$string['dashboard_viewtutorpanel'] = 'Ver el panel de';
$string['dashboard_viewtutorpanel_action'] = 'Ver panel del tutor';
...
$string['dashboard_summary_sopstudents'] = 'Alumnos con orientador SOP';
