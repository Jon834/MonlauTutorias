...
/**
 * Event triggered when a tutoring reason is created.
 *
 * @package    local_monlaututoria
 * @copyright  2026 Monlau Tutoria Project
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
final class reason_created extends catalogue_item_event_base {
    ...
    public static function get_name() {
        return get_string('eventreasoncreated', 'local_monlaututoria');
    }

    public function get_description() {
        return "The user with id {$this->userid} created the reason with id {$this->objectid}.";
    }
