...
/**
 * Event triggered when a tutoring reason is deleted (phase 3E.5 — same gap,
 * and same fix, as academic_year_deleted: create()/update()/set_active() all
 * fired an event, delete() did not).
 *
 * @package    local_monlaututoria
 * @copyright  2026 Monlau Tutoria Project
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
final class reason_deleted extends catalogue_item_event_base {
    ...
    public static function get_name() {
        return get_string('eventreasondeleted', 'local_monlaututoria');
    }

    public function get_description() {
        return "The user with id {$this->userid} deleted the reason with id {$this->objectid} "
