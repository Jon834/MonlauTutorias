...
/**
 * Event triggered when a contact modality is activated or deactivated.
 *
 * @package    local_monlaututoria
 * @copyright  2026 Monlau Tutoria Project
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
final class modality_activated extends catalogue_item_event_base {
    ...
    public static function get_name() {
        return get_string('eventmodalityactivated', 'local_monlaututoria');
    }

    public function get_description() {
        $action = !empty($this->other['active']) ? 'activated' : 'deactivated';

        return "The user with id {$this->userid} {$action} the modality with id {$this->objectid}.";
    }
