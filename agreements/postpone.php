...
/**
 * Postpones an agreement's due date (phase 6.3) — needs an actual form
 * (a new date), unlike complete/reopen/cancel which only need a confirmation
 * (see agreements/action.php).
 *
...
$PAGE->set_url('/local/monlaututoria/agreements/postpone.php', ['id' => $id]);
...
$form = new \local_monlaututoria\form\agreement_postpone_form(null, ['currentduedate' => (int) $agreement->duedate]);
