...
// Fase 13 — cohort → tutor bulk assignment stays available in simple mode
// (a real coordination need); only the CSV import path is hidden. Gated by
// the managecohortassignments capability, same as before.
